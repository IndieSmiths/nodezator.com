...
This is the custom, simple static website generator to generate the website for https://nodezator.com.

It turns .md files (markdown) into .html files representing both static pages or chronological content (articles, posts, news).
...
```
python3 addcommitlink.py
```

And it will add a link to the specific commit using the hash code generated by `git rev-parse HEAD` at the end of the website's footer.
